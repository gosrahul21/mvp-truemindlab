          ...
          <form className="mt-8 space-y-6" onSubmit={handleSignUp}>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#050810] text-gray-400">Or continue with</span>
              </div>
            </div>
            ...
            <div>
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-3 border border-gray-700 rounded-lg shadow-sm bg-gray-900/50 text-sm font-medium text-white hover:bg-gray-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
...
export default function SignUpPage() {
  return (
    <Suspense
      fallback={
        <Layout>
          <div className="min-h-screen flex items-center justify-center bg-[#050810] text-gray-400">
            Loading…
          </div>
        </Layout>
      }
