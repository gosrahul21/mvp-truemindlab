        ...
        <form className="mt-8 space-y-6" onSubmit={handleSignUp}>
          ...
          <div>
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-3 border border-gray-700 rounded-lg shadow-sm bg-gray-900/50 text-sm font-medium text-white hover:bg-gray-800 transition-all"
            >
